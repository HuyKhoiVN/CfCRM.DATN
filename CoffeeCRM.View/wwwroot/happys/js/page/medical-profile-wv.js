                    ...
                    if (resultAccountSurvey.data[0]) {
                        $("#medicalinfo_card_result").append(`
                            <div class="result-servey col-lg-6 ">
                                <a class="btn btnHS" href="/screen/chi-tiet-bai-trac-nghiem-sktt?id=`+ resultAccountSurvey.data[0].id + `">Xem lại kết quả trắc nghiệm SKTT gần nhất</a>
                            </div> 
                            <div class="col-lg-6 mt-4" hidden>
