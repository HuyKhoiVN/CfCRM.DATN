...
var loadDataCommentForumPost = async function LoadForumPost() {
    ...
    var result = await httpService.getAsync("forumpost/api/commentForumPostByAccountIdCustomer?accountId=" + id +"&pageIndex=" + pageIndex + "&pageSize=" + pageSize + "&search=" + search + "");
    var html = '';
