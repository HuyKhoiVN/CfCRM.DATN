            ...
            if (item.lastedPost == null) {
                $("#typical-category").append(`
                            <li>
                                ...
                                <a href="/danh-sach-dien-dan/`+ item.id + `">` + item.name + `</a> <span class="count">` + item.countPost + `</span>
                            </li>
                `
                )
            }
                                        ...
                                        <div class="freshness-box">
                                            <div class="freshness-top">
                                                <div class="freshness-link">
                                                    <a title="">`+ moment(data.lastedPost.createdTime).fromNow() +`</a>
                                                </div>
                                            </div>
                                            <div class="freshness-btm">
                                                <a href="#" title="" class="bbp-author-link">
                                                    <div class="freshness-name">
                                                        <a href="/dien-dan/chi-tiet-bai-viet/`+ data.lastedPost.id + `-` + data.lastedPost.url +`" title="" class="bbp-author-link">
...
async function LoadDataListLastestForumPost() {
    var result = await httpService.getAsync("forumpost/api/list-forum-post-top-10");
    $("#list-10-latest-forum-post").html('');
    if (result.status == "200") {
        var query = result.data
        query.forEach(function (item) {
            $("#list-10-latest-forum-post").append(`
                        <div class="col-12" style="display: flex;align-items: center;">
                            <div class="featured-member-photo">
                                <img src=`+ (item.photoUser ? item.photoUser : "/images/default/NoImage.png") + `>
                            </div>
                            <div class="featured-member-detail">
                                <div class="featured-member-name" style="font-weight: bold;">
                                    <a href="/dien-dan/chi-tiet-bai-viet/`+ item.id + ` - ` + item.url + `">` + item.name + `</a>
                                </div>
                                <div class="forum-post-count">
                                    `+ moment(item.publishedTime).fromNow() + `
                                </div>
                            </div>
                        </div>
            `
