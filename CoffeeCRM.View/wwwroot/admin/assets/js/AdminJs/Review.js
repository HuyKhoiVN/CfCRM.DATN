...
function initTable() {
    table = $('#tableData').DataTable({
...

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    return ` <div style='display: flex; flex-direction: row; gap: 10px; align-content: center'>
                                 <div>
                                     <img class='accountPhoto' height='32' width='32' src='${row.photo != null && row.photo != "" ? row.photo : 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png'}' alt='User'>
                                 </div>
                                 <div style= 'display: flex; flex-direction:column; gap: 4px;'>
                                     <span style='line-height: 14.7px;' class='fs-14' id='row1001-column-id'>${row.fullName}</span>
                                     <p style='font-size:12px;line-height: 12.6px; color: #044688; margin: 0'> <span style='display: inline-block; min-width: 111px; font-size:12px; color: #044688'>${row.accountTypeName}</span> MS:${row.id}</pstyle>
                                 </div>
                             </div>`;
                },
            },
...

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    return `<div style='display: flex; flex-direction:column; gap: 4px;'>
                                <span style='line-height: 14.7px; padding-left: 5px' class='fs-14' id='row1001-column-id'>-${data}</span>
                                <p style='font-size:12px;line-height: 12.6px; color: #044688; margin: 0'>Không tính doanh thu đơn hàng</p>
...

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    return `<div style='display: flex; flex-direction:column; gap: 4px;align-items: flex-start;'>
                                <span style='line-height: 14.7px; padding-left: 5px' class='fs-14' id='row1001-column-id'>-${data.toLocaleString('vi', { style: 'currency', currency: 'VND' }) }</span>
                                <p style='font-size:12px;line-height: 12.6px; color: #044688; margin: 0'>Không tính doanh thu đơn hàng</p>
                            </div>`;
                },
            },
        ...
        columnDefs: [
            ...
            { orderable: false, targets: [-1, 0, 2, 5] },
        ],
        aLengthMenu: [
            [10, 25, 50, 100],
            [10, 25, 50, 100]
