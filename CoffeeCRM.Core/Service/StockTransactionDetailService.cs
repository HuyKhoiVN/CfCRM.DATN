...
namespace CoffeeCRM.Core.Service
{
    public class StockTransactionDetailService : IStockTransactionDetailService
    {
        ...
        {
            return await stockTransactionDetailRepository.ListServerSideSummary(parameters);
        }
        ...
        {
            return await stockTransactionDetailRepository.GetRecentStockTransactions(number);
        }
    }
}
