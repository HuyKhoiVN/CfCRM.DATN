...
namespace CfCRM.DATN.Controllers
{
    ...
    {
        IStockTransactionDetailService service;
        public StockTransactionDetailController(IStockTransactionDetailService _service)
        {
            service = _service;
        }
        ...
        [HttpGet]
        [Route("api/RecentTrans")]
        public async Task<IActionResult> RecentTrans([FromQuery] int number)
        {
            try
            {
                var dataList = await service.GetRecentStockTransactions(number);
                if (dataList == null || dataList.Count == 0)
                {
                    return NotFound();
                }
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody] StockTransactionDetail model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody] StockTransactionDetail model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody] StockTransactionDetail model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody] StockTransactionDetail model)
        {
            var result = 0;
            if (!(model.Id > 0))
            {
        ...
        [HttpGet]
        [Route("api/Count")]
        public int CountStockTransactionDetail()
        {
        ...
        public async Task<IActionResult> ListServerSide([FromBody] StockTransactionDetailDTParameters parameters)
        {
            try
            {
        ...
        public async Task<IActionResult> ListServerSideSummary([FromBody] StockTransactionDetailDTParameters parameters)
        {
            try
            {
