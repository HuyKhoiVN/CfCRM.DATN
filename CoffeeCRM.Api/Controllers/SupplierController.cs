    ...
    namespace CfCRM.DATN.Controllers
    {
        ...
        public class SupplierController : ControllerBase
        {
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]Supplier model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]Supplier model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] SupplierDTParameters parameters)
            {
                try
                {
