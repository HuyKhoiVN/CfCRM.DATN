    ...
    namespace CfCRM.DATN.Controllers
    {
        ...
        {
            IInventoryAuditService service;
            public InventoryAuditController(IInventoryAuditService _service)
            {
                service = _service;
            }
            ...
            [HttpPost]
            [Route("api/Add")]
            public async Task<IActionResult> Add([FromBody]InventoryAudit model)
            {
            ...
            [HttpPost]
            [Route("api/Update")]
            public async Task<IActionResult> Update([FromBody]InventoryAudit model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]InventoryAudit model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]InventoryAudit model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            [HttpGet]
            [Route("api/Count")]
            public int CountInventoryAudit()
            {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] InventoryAuditDTParameters parameters)
            {
                try
                {
