    ...
    namespace CfCRM.DATN.Controllers
    {
        ...
        public class CashFlowController : ControllerBase
        {
            ...
            public CashFlowController(ICashFlowService _service)
            {
                service = _service;
            }
            ...
            [HttpPost]
            [Route("api/Add")]
            public async Task<IActionResult> Add([FromBody]CashFlow model)
            {
            ...
            [HttpPost]
            [Route("api/Update")]
            public async Task<IActionResult> Update([FromBody]CashFlow model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]CashFlow model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]CashFlow model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] CashFlowDTParameters parameters)
            {
                try
                {
